...
import { InputOptions } from "@ui/view-models/interfaces/input-options";
...
export class RegistrationFormComponent implements OnInit {
  ...
  private setSuccessOrErrorStatus(success: boolean) {
    if (success) {
      this.statusText = "Usuario registrado con éxito";
      this.statusButtonText = "Login";
      this.statusTitle = "Listo!";
    } else {
      this.statusText =
        "Hubo un error. No se pudo registrar el usuario. Por favor vuelve a intentar. Si el problema persiste, intentá más tarde.";
